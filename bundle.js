...
function setup() {
  ...
  searchInput.addEventListener("keydown", function (event) {
    ...
    render(_loader["default"], appContainer); //call api code
...
function countries(countriesArray) {
  ...
  for (var i = 0; i < countriesArray.length; i++) {
    listItems += "<li>".concat(countriesArray[i].name, " - ").concat(countriesArray[i].capital, " - ").concat(countriesArray[i].region, "</li>");
  }
